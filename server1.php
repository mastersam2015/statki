...
$.get("shoot1.php", { 'strzal' : ooo },  function(data) {
...
if(petla==3){
window.location.href ='server1.php';
}
}
}
...
<font color="ffffff">points<input type="text" id="punktacja" value="15"><br>
